...
typedef std::function<void(std::string, std::string, std::string, std::string)> CambioValClaves;
...
public:
  ...
  CambioValClaves OnCambioValClaves;
  ...
  ClienteCambiaDifusion OnClienteCambiaDifusion;
	...
	bool DeSuscribirse(std::string unCliente, std::string unaClave, std::string unaSubClave);
